...
function drawTimeData(timeData) {
  ...
  analyzer.getByteTimeDomainData(timeData); // with data, lets turn it into a visual
  // first, clear canvas

  ctx.clearRect(0, 0, WIDTH, HEIGHT); // second, set up some canvas drawing
...
function drawFrequency(frequencyData) {
  ...
  analyzer.getByteFrequencyData(frequencyData); // 2. figure out bar width
  ...
  frequencyData.forEach(amount => {
    ...
    const barHeight = HEIGHT * percent * 0.5; // convert color to HSL
